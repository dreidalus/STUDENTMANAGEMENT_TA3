...
<div class="container p-5">
    ...
    <form method="post" enctype="multipart/form-data" action="/students/update/<?= $student['students_id'] ?>">
        <?= csrf_field() ?>
        <div class="mb-3">
    ...
    <div class="mb-2">
        ...
        <img src="data:image/jpeg;base64,<?= base64_encode($student['image']) ?>" width="100" height="100" style="object-fit: cover; border-radius: 5px;">
    </div>
<?php endif; ?>
