...
public function index()
{
    ...
    $grades = $model->select('grades.grades_id, students.first_name, students.last_name, grades.year_start, grades.year_end, grades.grade_first_sem, grades.grade_second_sem')
