...
$routes->get('students-api', 'StudentsApi::index');
$routes->get('students-api/(:num)', 'StudentsApi::show/$1');
$routes->post('students-api', 'StudentsApi::create');
$routes->put('students-api/(:num)', 'StudentsApi::update/$1');
$routes->delete('students-api/(:num)', 'StudentsApi::delete/$1');
